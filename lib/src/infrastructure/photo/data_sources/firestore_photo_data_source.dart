...
class FirestorePhotoDataSource implements IRemoteDataSource<PhotoDto> {
  ...
  @override
  Stream<PhotoDto> watch(UniqueId uid) => throw UnimplementedError();

  @override
  Stream<List<PhotoDto>> watchAllForUser(UniqueId userId) async* {
