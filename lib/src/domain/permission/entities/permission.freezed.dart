...
abstract class $PermissionCopyWith<$Res> {
  ...
  @useResult
  $Res call({PermissionType type, PermissionStatus status});
}
...
class _$PermissionImpl implements _Permission {
  const _$PermissionImpl({required this.type, required this.status});
  ...
  @override
  String toString() {
    return 'Permission(type: $type, status: $status)';
  }
...
abstract class _Permission implements Permission {
  const factory _Permission(
      ...
      required final PermissionStatus status}) = _$PermissionImpl;
